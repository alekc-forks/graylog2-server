...
public class UniversalJsonCodec extends AbstractCodec implements MultiMessageCodec {
    ...
    private DateTime timestampValue(final JsonNode json, final DateTime defaultDate) {
        ...
        if (enableCustomTimeFormat && !value.isMissingNode()) {
            final Date date;
            try {
                date = new SimpleDateFormat(this.customTimeFormat).parse(value.asText());
    ...
    public static class Config extends AbstractCodec.Config {
        ...
        public ConfigurationRequest getRequestedConfiguration() {
            ...
            requestedConfiguration.addField(new TextField(
                    ...
                    "Custom timestamp format. Must be a valid value for DateTimeFormatter",
